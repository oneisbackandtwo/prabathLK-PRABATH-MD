...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "PRABATH-MD~ZjUhyS4C#VcNKjQrHBmGbXhujAlhG8Dxg7ww63fzX0g8KsJjMFQU",
BOT_NUMBER: process.env.BOT_NUMBER || "94705564619",
PASSWORD: process.env.PASSWORD || "sujee@123",
GITHUB_USERNAME: process.env.GITHUB_USERNAME || "oneisbackandtwo",
